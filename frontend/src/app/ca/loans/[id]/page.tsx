// Path: frontend/src/app/ca/loans/[id]/page.tsx
"use client";
    ...
    <CALayout s={s} userName={userName} handleLogout={handleLogout}>
      <div className="ca-view-wrap">
        ...
        <div className="ca-top-bar">
          ...
          {app && (
            <div className="ca-top-actions">
              ...
              {canEdit ? (
                <button style={s.editBtn} onClick={() => router.push(`/ca/loans/${id}/edit`)}>
        ...
        {loading ? (
          ...
          <>
            {/* Status Banner */}
            <div className="ca-status-banner" style={{ borderColor: sc.color, background: sc.bg + "80" }}>
            ...
            <div className="ca-grid">
              ...
              {/* CA Info */}
              <InfoCard title="Filed By (CA)" icon={<FaUserTie />} color="#f59e0b">
              ...
              {/* Other Documents */}
              {otherDocs.length > 0 && (
                <div className="ca-full-span" style={s.card}>
...
function Row({ label, value, capitalize }: { label: string; value: string; capitalize?: boolean }) {
  return (
    <div className="ca-row" style={s.row}>
